...
public class CanadarmControl : MonoBehaviour {
    ...
    void Start() {
        ...
        //kinematics.forward_kinematics(angles);
        kinematics.build_canadarm_jacobian(angles);

        /*print(all_joints[0].transform.position);
        print(all_joints[1].transform.position);
        print(all_joints[2].transform.position);
        print(all_joints[3].transform.position);
        print(all_joints[4].transform.position);
        print(all_joints[5].transform.position);
        print(all_joints[6].transform.position);
        print(all_joints[7].transform.position);*/

        if (record_EEG)
        {
            //markerStream.Write("100", Time.time - startTime);
            mark[0] = "100";
    ...
    void Update() {
        ...
        //if (target_pos_changed && task_started)
        if (task_started)
        {
            ...
            if (latency > 0.0f)
            {
                ...
                {
                    // Turn currently selected camera
            ...
            for (int i = 0; i < all_joints.Length - 1; i++)
            {
                ...
                //all_joints_ui[i].value = all_joints[i].joint_target;
            }
    ...
    {
        //ee_target.transform.parent = null;
    ...
    public void Save_Data()
    {
        ...
        //markerStream.Write((-1000).ToString(), Time.time);
        mark[0] = "1000";
        mark[1] = (Time.time).ToString();
        markerStream.Write(mark);
